	...
	return(
		<div className="about-app-modal">
			...
			<ul>
				...
				<li><strong>Picture Gazing: </strong>If you don't know where to find a plant, or are otherwise unable to obtain it, that's okay. You can connect with a plant by focusing on a picture of it. You'll benefit even if it's simply by appreciating its physical beauty.</li>
			</ul>
